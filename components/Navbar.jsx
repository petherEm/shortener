    ...
    <nav className="relative container mx-auto p-6">
      ...
      <div className={openMenu ? "absolute p-6 rounded-lg bg-darkViolet left-6 right-6 top-20 z-100" : "absolute hidden p-6 rounded-lg bg-darkViolet left-6 right-6 top-20 z-100" }>
        <div className="flex flex-col items-center justify-center w-full space-y-6 font-bold text-white rounded-sm">
          ...
          <Link href="#" className="w-full text-center">Resources</Link>
          <Link href="#" className="w-full text-center pt-6 border-t border-gray-400">Login</Link>
          <Link href="#" className="w-full text-center py-3 rounded-full bg-cyan">Sign Up</Link>
        </div>
      </div>
    </nav>
  );
